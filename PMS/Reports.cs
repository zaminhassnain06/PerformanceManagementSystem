...
namespace PMS
{
    static class   Reports
    {
        ...
        /// </summary>
        /// <param name=ds></param>
        //public static void ExportDataSetToExcel(DataTable dtbl, string strPath)
        //{
        //    try
        //    {
        ...
        //        excelWorkSheet.Name = "Employee_Attendance";//Name worksheet
        //        //Write Column Name
        ...
        //        excelWorkSheet.Cells[1, 1] = "Worker Attendance";
        ...
        public static void ExportDataSetToExcel(DataTable dtbl, string strPath, string EmpName)
        {
            try
            {
                ...
                string sxs = rdd + ".xlsx";
                string date = DateTime.Now.ToString().Replace(':', '-') + ".xlsx";
                strPath += @"\" + EmpName + "_" + " Attendance_Report " + sxs;
        ...
        public static void ExportDataSetToExcelOverAllReport(DataSet ds, string strPath,string ItemName)
        {
            ...
            //Create Excel File
                ...
                string sxs = rdd + ".xlsx";
                string date = DateTime.Now.ToString().Replace(':', '-') + ".xlsx"; ;
                strPath += @"\"+ItemName+"_"+" OverAllReport " + sxs;
                //strPath += DateTime.Now.ToString().Replace(':', '-') + ".xlsx";
                OfficeExcel.Application excelApp = new OfficeExcel.Application();
                OfficeExcel.Workbook excelWorkBook = excelApp.Workbooks.Add(1);
