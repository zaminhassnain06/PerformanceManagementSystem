...
namespace PMS
{
    public partial class CostOfInhouseRejectionKPI : Form
    {
        private int Item_Id = 0;
        private int Month_Id = 0;
    
        public CostOfInhouseRejectionKPI(int itemId)
        {
            InitializeComponent();
            if (itemId > 0)
            {
        ...
        {
            DataTable dt = new DataTable();
            dt = ButtonsUtility.GetCalculationsInhouseRejectionCostMonthly(Item_Id, dateTimePickerCostInhouseRej.Value.Year);
            ...
            try
            {
                ...
                if (chartCostOfRejectionKPI.Series.IndexOf("Cost of Inhouse Rejection Achieved") != -1)
                {
                    chartCostOfRejectionKPI.Series.Clear();
                }
                if (chartCostOfRejectionKPI.Series.IndexOf("Cost of Inhouse Rejection Not Achieved") != -1)
                {
                    chartCostOfRejectionKPI.Series.Clear();
                }
                chartCostOfRejectionKPI.Series.Add("Cost of Inhouse Rejection Achieved");
                chartCostOfRejectionKPI.Series.Add("Cost of Inhouse Rejection Not Achieved");

                chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Achieved"].Color = Color.LightGreen;
                chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Not Achieved"].Color = Color.IndianRed;
                for (int i = 0; i < rows; i++)
                {
                    if (dt.Rows[i][3].ToString() == "Achieved")
                    {

                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Achieved"].Points.AddXY(dt.Rows[i][0].ToString(), dt.Rows[i][1]);
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Not Achieved"].Points.AddXY(dt.Rows[i][0].ToString(), 0);
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Achieved"].Points[i].IsValueShownAsLabel = true;
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Not Achieved"].Points[i].IsValueShownAsLabel = false;
                    }
                    else
                    {
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Achieved"].Points.AddXY(dt.Rows[i][0].ToString(), 0);
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Not Achieved"].Points.AddXY(dt.Rows[i][0].ToString(), dt.Rows[i][1]);
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Achieved"].Points[i].IsValueShownAsLabel = false;
                        chartCostOfRejectionKPI.Series["Cost of Inhouse Rejection Not Achieved"].Points[i].IsValueShownAsLabel = true;
                    }
        ...
        private void comboBoxItemsReworkRatioKPI_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Item_Id > 0)
            {
                ButtonsUtility.SaveMonthsforObservationsActivitiesInhouseRejectionCost(Item_Id);
                GetGridCalculations();
                GetObervationActivities();
            }
            if (Item_Id > 0 && Month_Id > 0)
            {
                decimal MonthTarget = ButtonsUtility.GetMonthTargetCostofInhouseRejection(Month_Id, Item_Id, dateTimePickerCostInhouseRej.Value.Year);
        ...
        {
            int row = ButtonsUtility.InsertTargetInhouseRejcectionkCost(Item_Id, Month_Id, Convert.ToDecimal(textBoxTarget.Text), dateTimePickerCostInhouseRej.Value.Year);
        ...
        {
            int row = ButtonsUtility.EditTargetInhouseRejCost(Item_Id, Month_Id, Convert.ToDecimal(textBoxTarget.Text), dateTimePickerCostInhouseRej.Value.Year);
        ...
        private void GetObervationActivities()
        {
            ...
            ds = ButtonsUtility.GetActivitesObservationInhouseRejCost(Item_Id);
        ...
        private void dataGridViewCostOfRejectionKPIObs_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ButtonsUtility.EditInhouseRejectionCostObservation(Item_Id, dgvObsRow.Cells[1].Value == DBNull.Value ? "" : dgvObsRow.Cells[1].Value.ToString(), rowindex + 1, 0);
            GetObervationActivities();  
        }
        ...
        private void dataGridViewAcitvityCostOfRejectionKPI_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ButtonsUtility.EditInhouseRejectionCostObservation(Item_Id, dgvObsRow.Cells[1].Value == DBNull.Value ? "" : dgvObsRow.Cells[1].Value.ToString(), rowindex + 1, 1);
            GetObervationActivities();   
        }
        ...
        private void dateTimePickerCostInhouseRej_ValueChanged(object sender, EventArgs e)
        {
