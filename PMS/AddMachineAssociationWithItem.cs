...
namespace PMS
{
    public partial class AddMachineAssociationWithItem : Form
    {
        ...
        public AddMachineAssociationWithItem(int ItemId)
        {
            InitializeComponent();
        ...
        private void GetMachines()
        {
            ...
            dt = ButtonsUtility.GetAllMachines();
            string MachineCode = "";
            string MachineName = "";
            ...
            else
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    MachineCode = dt.Rows[i][1].ToString();
        ...
        {
            if (comboBoxMachineSelection.Text == "")
            {
            ...
            else
            {
                ...
                int rows = ButtonsUtility.SaveMachineItem(Machine_Code, Item_Id);
                ...
                {
                    labelAlreadyAssociated.Visible = true;
                }
            }
        }
        ...
        private void GetGridData()
        {
            ...
            if (rows > 0)
            {
                ...
                for (int i = 0; i < rows; i++)
                {
                    ...
                    dataGridViewMachineDetails.Rows.Add(dt.Rows[i][0], dt.Rows[i][1], "Remove Machine");
        ...
        private void comboBoxMachineSelection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            labelSelectaMachinePlease.Visible = false;
            labelAlreadyAssociated.Visible = false;
