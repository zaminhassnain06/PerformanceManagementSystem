...
namespace PMS
{
    public partial class AddNewFactory : Form
    {
        private int AlreadySaved = 0;
        public AddNewFactory()
        {
            InitializeComponent();

            GetFactory();
            if(textBoxFactoryName.Text!="")
            {
        ...
        private void GetFactory()
        {
            ...
            dt = ButtonsUtility.ViewFactory();
            string facName = dt.Rows[0][0].ToString();


            textBoxFactoryName.Text = facName;
            textBoxShiftTime.Text = dt.Rows[0][1].ToString();
            textBoxBreakTime.Text = dt.Rows[0][2].ToString();
        ...
        {
            int rowseffected = ButtonsUtility.SaveFactory(textBoxFactoryName.Text,Convert.ToInt32(textBoxShiftTime.Text),Convert.ToInt32(textBoxBreakTime.Text));
            if(rowseffected>0)
            {
                labelFacInfoInsertSucess.Visible = true;
            }
        ...
        {
            labelFacInfoInsertSucess.Visible = false;
            labelfacinfoUpdateSucessful.Visible = false;
        }

        private void buttonEdit_Click(object sender, EventArgs e)
        {
            int rowseffected = ButtonsUtility.EditFactory(textBoxFactoryName.Text, Convert.ToInt32(textBoxShiftTime.Text),Convert.ToInt32(textBoxBreakTime.Text));
            if (rowseffected > 0)
            {
                labelfacinfoUpdateSucessful.Visible = true;
            }
        }
        ...
        private void textBoxShiftTime_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void textBoxBreakTime_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((!char.IsNumber(e.KeyChar)) && (!char.IsControl(e.KeyChar)))
            {
